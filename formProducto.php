...
function obtenerFormulario($campos, $boton) {
    ...
    foreach ($campos as $titulo => $campo) {
        if ($boton == "add") {   
            if($titulo != "num_ref" && $titulo != "descripcion"){
                ...
                $formulario .= "<div class = 'campo col-xl-6 px-4'><label>$titulo</label><br/>";
                $formulario .= "<textarea rows='5' name = 'valorNuevo[]' value = '' class='inputData'> </textarea><br />";
                $formulario .= "<input type = 'hidden' name = 'campos[$titulo]' value = '$campo' class='inputData'/><br />" .
                "<input type = 'hidden' name = 'valorAnt[]' value= '$campo' />";
            }
        } else {
            if($titulo == "num_ref"){
            ...
            }else if($titulo != "num_ref" && $titulo != "descripcion"){
                $formulario .= "<div class = 'campo col-xl-6 px-4'><label>$titulo</label><br/>";
                ...
                $formulario .= "<div class = 'campo col-xl-6 px-4'><label>$titulo</label><br/>";
                $formulario .= "<textarea rows='5' name = 'valorNuevo[]' value = '$campo' class='inputData'>$campo</textarea><br />";
                $formulario .= "<input type = 'hidden' name = 'campos[$titulo]' value = '$campo' class='inputData'/><br />" .
                "<input type = 'hidden' name = 'valorAnt[]' value= '$campo' />";
            }
