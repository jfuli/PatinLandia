...
// if ($_POST['payment_status'] == 'Completed' && $_POST['result'] == 'VERIFIED' && !isset($_SESSION['pedidoHecho'])) {
...
function obtenerListado($conexion) {
    ...
    foreach ($datos as $dato) {
        ...
        if ($uds > 10) {
            $boton = "<input class='shop-btn' type='submit' value='Añadir al carrito' name='cestaAccion' $disabled>";
        } else {
            $boton = "<p> Sin stock</p>";
        }
