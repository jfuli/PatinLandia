        ...
        <fieldset class="cajaLogin">
            ...
            <div class="iniciarSesion col-lg-6 col-md-12 col-sm-12">
                <form class="formLogin" role="form" action='login.php' method='post' id="formLogin"
                    ...
                    <p>¿Ya conoces las ventajas que tiene tener una cuenta de usuario en la web de PATINLANDIA? Con ella
                        podrás comprar nuestros productos y tener un historial. Anímate y hazte una cuenta con el
                        formulario de registro de la derecha. Si ya tienes una cuenta, ¿a qué esperas?, accede ahora
                        introduciendo tus credenciales en el formulario de tu izquierda.</p>
                    <div class='campo'>
